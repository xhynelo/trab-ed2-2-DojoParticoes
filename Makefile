...
_DEPS = cliente.h lista_clientes.h nomes.h geracao_particoes.h ufftest.h
DEPS = $(patsubst %,$(IDIR)$(SEP)%,$(_DEPS))

_OBJ = geracao_particoes.o cliente.o lista_clientes.o nomes.o test_geracao_particoes.o
